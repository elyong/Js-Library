 ...
 * @param {String} str
 */
Base.filter = function (str) {
  var REGEXP_TAG = /<(script|style|iframe)[^<>]*?>.*?<\/\1>/ig  // eslint-disable-line
  var REGEXP_ATTR_NAME = /(onerror|onclick)=([\"\']?)([^\"\'>]*?)\2/ig  // eslint-disable-line
